...
[N29-39 Phelx's Scarlet Monastery Library Onwards Guide (Horde).]
[D Phelx's guide to getting the all quests for SM Library. You can begin to obtain quests from [XP25 25] however it's recommended to be at least [XP33 33]. There are 3 total, one of which is unavailable to Undead, with a 4th for Mages found "30 SM (Mage Only)".]
[GA Horde]

[OC] Follow [NX 25 SM Library PreQuest] to be able to get [Q1160].
[A Mage][OC] Follow [NX 30 SM (Mage Only)] to be able to get [Q1951].
[A Tauren,Orc,Troll] If you don't have [Q1049], fly to [F Thunder Bluff].
[A Tauren,Orc,Troll] Go to [G 34.6,47.2 Thunder Bluff] and speak to [TAR3978] to accept [QA1049].
