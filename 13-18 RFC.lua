...
[N13-18 Phelx's Ragefire Chasm (RFC) Guide]
[D Phelx's guide to acquiring all RFC quests. There are 5 total.]
[GA Horde]

All quests require a minimum level of [XP9 9].
[A Tauren] If you are levelling in Mulgore, be sure to enter Thunderbluff and accept [QA5722][QA5723] from Rahauro.
[A Tauren] Then get the Flightpath [P Thunderbluff] and run to Orgrimmar.
...
Get the Flightpath [P Undercity] for levelling convenience later on.
...
Speak to [G49,50 Orgrimmar]Neeru Fireblade then return to Thrall and turn in [QT5727], then accept [QA5728].
